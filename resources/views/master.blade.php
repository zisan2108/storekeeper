...
<head>
    ...
    <link href="{{ asset('website') }}/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="{{ asset('website') }}/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('website') }}/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('website') }}/js/demo/chart-area-demo.js"></script>
    <script src="{{ asset('website') }}/js/demo/chart-pie-demo.js"></script>
